...
the spectrogram samples buffered over a period of one second to the Inference Engine XAF component.  The Inference Engine XAF 
component includes the interpreter as well as the optimized operators.  The output of the Inference Engine is the probability 
of recognizing Yes, No, Silence or Unknown.
